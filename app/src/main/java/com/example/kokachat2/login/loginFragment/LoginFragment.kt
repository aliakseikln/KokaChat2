package com.example.kokachat2.login.loginFragment
...
import com.example.kokachat2.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    private fun verifyNumber() {
        ...
        if (phoneNumber.isEmpty() || binding.etPhoneNumber.text.toString().length != 9) {
    ...
    private fun showOtpFragment() {
        clearText()
        val action =
            LoginFragmentDirections.actionLoginFragmentToOtpFragment(phoneNumber = phoneNumber)

package com.example.kokachat2.chat.contactFragment
...
import com.example.kokachat2.databinding.FragmentContactBinding
...
class ContactFragment : Fragment(), CardClick {
    ...
    override fun onContactClick(contact: User) {
        val action =
            ContactFragmentDirections.actionContactFragmentToMessageActivity(receiver = contact)
